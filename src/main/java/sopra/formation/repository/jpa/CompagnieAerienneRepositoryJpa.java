...
public class CompagnieAerienneRepositoryJpa {
	...
	public List<CompagnieAerienne> findAll() {
		...
		try {
			...
			TypedQuery<CompagnieAerienne> query = em.createQuery("select p from CompagnieAerienne p", CompagnieAerienne.class);
